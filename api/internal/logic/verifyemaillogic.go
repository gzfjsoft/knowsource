...
func (l *VerifyEmailLogic) VerifyEmail(req *types.VerifyEmailRequest) (resp *types.Response, err error) {
	...
	if err != nil {
		return newResponse(response.ServerErrorCode, "服务器错误，请联系客服", "(UpdateUser)"+err.Error()), nil
	}
