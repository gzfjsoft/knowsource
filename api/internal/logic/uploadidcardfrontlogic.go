...
type UploadIdcardFrontLogic struct {
	logx.Logger
	ctx    context.Context
...
func NewUploadIdcardFrontLogic(ctx context.Context, r *http.Request, svcCtx *svc.ServiceContext) *UploadIdcardFrontLogic {
	return &UploadIdcardFrontLogic{
...
func (l *UploadIdcardFrontLogic) UploadIdcardFront() (resp *types.UploadResponse, err error) {
	...
	newFilename := fmt.Sprintf("%d_%s_f_%s%s", uid, datestr, uuid[:8], fileExt)
