...
func NewTestLogic(ctx context.Context, svcCtx *svc.ServiceContext) *TestLogic {
	return &TestLogic{Logger: logx.WithContext(ctx), ctx: ctx, svcCtx: svcCtx}
}

func (l *TestLogic) Test(req *types.KnowsourceTenantSendVerificationCodeRequest) (resp *types.Response, err error) {
	...
	body := fmt.Sprintf(`<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;"><h2 style="color: #333;">租户邮箱验证</h2><p>尊敬的用户：</p><p>您好！您正在进行 知源智库 AI租户邮箱验证，以下是您的验证码：</p><div style="background-color: #f5f5f5; padding: 20px; margin: 20px 0; border-radius: 5px;"><p style="font-size: 24px; font-weight: bold; text-align: center; color: #333;">%s</p></div><p>验证码有效期为 15 分钟，请及时使用。</p><p>如果您没有发起此操作，请忽略此邮件。</p><p>此致<br>知源智库 AI团队</p></div>`, code)
